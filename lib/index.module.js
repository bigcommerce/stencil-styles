...
module.exports = function StencilStyles() {
    ...
    self.compileCss = function (compiler, options, callback) {
        switch(compiler) {
            case 'scss':
                ...
                break;
            case 'less':
                self.lessCompiler(options, doneCompiling);
                break;
        }
    ...
    self.scssCompiler = function (options, callback) {
        ...
        sassFunctions['stencilFontFamily($name)'] = function(nameObj) {
            return self.stencilFont(options, nameObj, 'family');
        };

        sassFunctions['stencilFontWeight($name)'] = function(nameObj) {
            return self.stencilFont(options, nameObj, 'weight');
        };
    ...
    self.stencilFont = function(options, nameObj, type) {
        var name = nameObj.getValue(),
     ...
     * @param callback
     */
    self.lessCompiler = function (options, callback) {
        var themeVariables = '',
            lessOptions = {
